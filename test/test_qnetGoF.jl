...
@test netresult1[4] == Dict("[0.0, 0.01)"=>6,"[0.01, 0.05)"=>2,"[0.1, 1.0]"=>7)
...
@test netresult1[4] == Dict("[0.0, 0.01)"=>2,"[0.01, 0.05)"=>4,"[0.1, 1.0]"=>9)
end

@testset "Qlog statistic for 4-taxon set with small expected values" begin
netresult1 = quarnetGoFtest(d, :Qlog, :none);
@test netresult1[1] ≈ 6.21966321647047  # z stat
@test netresult1[2] ≈ 1.0 # sigma2
