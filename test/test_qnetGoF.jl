...
@test netresult1[4] == Dict("[0.0, 0.01)"=>6,"[0.01, 0.05)"=>2,"[0.05, 0.1)"=>0,"[0.1, 1.0]"=>7)
...
@test netresult1[4] == Dict("[0.0, 0.01)"=>2,"[0.01, 0.05)"=>4,"[0.05, 0.1)"=>0,"[0.1, 1.0]"=>9)
end
...
@test netresult1[2] == Dict("[0.05, 0.1)"=>2,"[0.0, 0.01)"=>4,"[0.01, 0.05)"=>2,"[0.1, 1.0]"=>7)
end
